...
public class DrawLineTemperature extends View {
	...
	public DrawLineTemperature(Context context, AttributeSet attrs, int defStyleAttr) {
	...
	protected void onDraw(Canvas canvas) {
		...
		Log.e("AAAA.", "Draw temprature  " + mDataLen);
